...
{
    public class LakasRepository : Repository<Lakas>, ILakasRepository
    {

        //87 , majd 91nél copy a UnitoF Workben a constructort
        private ApplicationDbContext _db;
        public LakasRepository(ApplicationDbContext db) : base(db)
        {
            _db = db;
        }
        ...
        */
        ...
        public void Update(Lakas obj)
        {
            _db.Lakasok.Update(obj);
            //throw new NotImplementedException();
        }
